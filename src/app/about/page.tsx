...
export default function AboutPage() {
  ...
  return (
    <main style={{
      background: '#0e0e0e', minHeight: '100vh', color: '#fff',
      ...
      <section style={{
        ...
        <h1 style={{
          fontFamily: 'Space Grotesk,sans-serif', fontSize: 'clamp(36px,6vw,72px)',
        ...
        <p style={{
          color: '#adaaaa', fontSize: '16px', maxWidth: '560px',
        ...
        <div style={{
          ...
          <div>
            <h2 style={{
              ...
              marginBottom: '4px'
            }}>Avi Mohan<br />Kumar Shuklaa</h2>
            <p style={{
              fontFamily: 'JetBrains Mono,monospace', fontSize: '11px',
              color: '#00fdc1', letterSpacing: '0.2em', textTransform: 'uppercase',
              marginBottom: '28px'
            }}>Founder & CEO, Innobotix</p>

            <div style={{
              borderLeft: '2px solid #00fdc1', paddingLeft: '20px',
              marginBottom: '28px'
            }}>
            ...
            <p style={{
              color: '#adaaaa', fontSize: '15px', lineHeight: 1.8,
              marginBottom: '32px'
            }}>
      ...
      <section style={{ background: '#131313', padding: '80px 24px' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          ...
          <h2 style={{
            fontFamily: 'Space Grotesk,sans-serif', fontSize: '40px',
      ...
      <section style={{ background: '#131313', padding: '80px 24px' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          ...
          <div style={{
            ...
            <p style={{
              color: '#e0e0e0', fontSize: '16px', lineHeight: 1.9,
